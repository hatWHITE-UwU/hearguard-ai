...
- **Asesor(es):** Maglioni Arana Caparachín
...
La siguiente tabla muestra ejemplos representativos de la trazabilidad entre escenarios Gherkin y casos de prueba automatizados a través de las cinco capas:
