...
| `README.md` | Requisitos de instalación y variables de entorno<br>• Configuración Docker y procedimiento de despliegue<br>• Ejecución de las 507 pruebas automatizadas (incluyendo 85 escenarios BDD Gherkin) |
