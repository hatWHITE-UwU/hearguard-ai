...
ARTEFACTOS: list[Artefacto] = [
    ...
    Artefacto("ART-006", "CI/CD", "INT-003-BOLT-001",
              ...
              "7 jobs: backend, ai-service, frontend, e2e, flutter, sonarcloud, deploy"),
...
PMV_ITEMS: list[PmvItem] = [
    ...
    PmvItem("PMV-008", "CI/CD GitHub Actions", "INT-003-BOLT-001", "DevOps", "Completo",
            "7 jobs automatizados: test + lint + coverage + sonarcloud + deploy"),
...
def _write_actividades_bpmn(wb: Workbook) -> None:
    ...
    actividades = [
        ...
        ("INT-003-BOLT-001", "P-009", "Configurar GitHub Actions CI",        "DevOps",         "Tarea de Servicio", "7 jobs: backend, ai, frontend, e2e, flutter, sonar, deploy","github/workflows/ci.yml"),
